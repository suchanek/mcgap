...
class MotorControl:
    ...
    def readAlrm(self):
        """
        Read alarm status. Connects and disconnects
    ...
    def readDelay(self, position):
        ...
        delay = (abs(rp - position)) * 1.2 / self.speed
        ldelay = delay
...
class MakeTab:
    ...
    def tablet1(self):
        ...
        # I am not sure this call via lambda is correct. why the "enter?" -egs-
