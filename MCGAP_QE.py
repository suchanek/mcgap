...
class MotorControl:
    ...
    def setGearing(self, gearA, gearB, gearBox):
        ...
        if self.checkMotor():
            ...
            if self.chkAlrm():
                self.showAlrm()
                print("Unable to reset electronic gearing")
        else:
            print("Unable to reset electronic gearing")
...
class MakeTab:
    ...
    def tablet4(self):
        ...
        tk.Label(page[4], font=10, text=steps + " steps per " + degree + u"\u00b0").place(x=-10, y=200, width=250, height=25)
