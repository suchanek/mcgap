...
class MotorControl:
    ...
    def sendMotor(self):
        ...
        if int(delta) > 0:
            if DBG2:
                print(">>> sendMotor: Send Forward unit: ", self.unit, self.position)
...
M3 = MotorControl(3, port485, 10000, 0, 1000, 0, 65535, 100000)
M4 = MotorControl(4, port485, 10000, 0, 1000, 0, 65535, 100000)
